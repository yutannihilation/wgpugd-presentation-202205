...
::: {.column width="50%"}
-   普段は wiki と SQL を書く仕事をしています
-   趣味で[家電を電子楽器に改造する団体](https://www.electronicosfantasticos.com/)に入っています
-   [ggplot2](https://github.com/tidyverse/ggplot2)、[conflr](https://github.com/line/conflr) のメンテナをしています
-   好きな言語：R、忍殺語
:::
:::
...
!\[いい感じのイメージ図がここに入る未来が見える\](images/iikanji.gif)
